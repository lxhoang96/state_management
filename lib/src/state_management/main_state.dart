...
final class MainState implements MainStateInterface {
...
final class _HistoryOrder {
  ...
  // ✅ Cache hashCode for better performance
  late final int _hashCode;
  
  _HistoryOrder(this.functionName, this.params) {
    // ✅ Pre-compute hash code once
    _hashCode = Object.hash(
      functionName,
      Object.hashAll(params.where((param) => param != null)),
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    if (other is! _HistoryOrder) return false;
    if (hashCode != other.hashCode) return false; // ✅ Hash comparison first
    if (functionName != other.functionName) return false;
    
    // ✅ Length check before expensive list comparison
    if (params.length != other.params.length) return false;
    
    // ✅ Manual comparison with early termination
  ...
  @override
  String toString() => '$functionName(${params.join(', ')})';
}